...
# Configuration
API_KEY = os.environ.get('GLASSDOOR_API_KEY', 'your-api-key-here')
...
# Company Reviews
@app.route('/api/v1/companies/<company_id>/reviews', methods=['GET'])
@require_api_key
def get_company_reviews(company_id):
    ...
    reviews = data.get('data', {}).get('reviews', []) if data else []
...
# Company Salaries
@app.route('/api/v1/companies/<company_id>/salaries', methods=['GET'])
@require_api_key
...
# Company Interviews
@app.route('/api/v1/companies/<company_id>/interviews', methods=['GET'])
@require_api_key
...
# Company Benefits
@app.route('/api/v1/companies/<company_id>/benefits', methods=['GET'])
@require_api_key
...
# Company Photos
@app.route('/api/v1/companies/<company_id>/photos', methods=['GET'])
@require_api_key
...
# CEO Information
@app.route('/api/v1/companies/<company_id>/ceo', methods=['GET'])
@require_api_key
